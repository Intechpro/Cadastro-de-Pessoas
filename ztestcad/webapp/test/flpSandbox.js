		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#intechprocombrztestcad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"intechprocombrztestcad-display": {
								"semanticObject": "intechprocombrztestcad",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=intechpro.com.br.ztestcad",
									"url": sap.ui.require.toUrl("intechpro/com/br/ztestcad")
								}
							}
						}
					}
